    ...
    <>
      <Conteiner largura={'100%'} altura={'100px'}>
        ...
        <div className='podioMeio'>
          <p className='nomeUser'>{username}</p>
          <p className='pontuacao'>pontuação: 0xp</p> {/* lógica p/ pontos */}
        </div>

        <Conteiner largura={'30%'} altura={'100%'}>  {/* so o usuario pode ver */}
          <div className='funcao'></div> {/* lógica p/ funções + opc ocultar */}
          </Conteiner>
      </Conteiner>
    </>
  );
